...
class CommentAdapter(private val context: Context, private var commentModelList: MutableList<CommentModel>, private val currentUsername: String) : RecyclerView.Adapter<CommentAdapter.ViewHolder>() {
